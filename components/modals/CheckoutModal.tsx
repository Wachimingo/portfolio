    ...
    return (
        <div className='bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <table className="table-fixed border-2">
                <thead>
                    <tr className="border-2 bg-slate-400">
                        ...
                        <th className="border-2 w-96">Plato</th>
                        <th className="border-2 w-20">Cantidad</th>
                        <th className="border-2 w-20">Precio</th>
                    </tr>
                </thead>
                <tbody>
                    {
                        selectedDishes?.map((item: any, i: number) => {
                            ...
                            const index = indexArray.filter((x: any) => { return x !== undefined })
                            return (
            ...
            <table className="table-auto border-2 ml-28 ">
                <thead>
                    <tr className="border-2 bg-slate-400">
                        <th className="border-2 w-40">Total Platos</th>
                        <th className="border-2 w-40">Total a Pagar</th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="border-2">
