...
const CatalogModal = dynamic<any>(() => import('../../../components/CatalogModal').then((mod) => mod.CatalogModal));
...
const catalog = ({ items, favs, categories, token, userId }: propsType) => {
...
export const getServerSideProps: GetServerSideProps = async (context) => {
    try {
        ...
        const categories = await res3.json() ?? null;
